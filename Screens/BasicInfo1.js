...
function BasicInfo1({navigation}) {
  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.row2}>
        ...
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Text style={styles.back2}>뒤로</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.inputContainer}>
        <TouchableOpacity onPress={() => setModalVisible(true)}>
          <View style={styles.pickerContainer}>
            <Text style={styles.pickerText}>학력을 선택해주세요</Text>
          </View>
        </TouchableOpacity>
        <Modal
          animationType="slide"
      ...
      <Text style={styles.subtitle}>직장</Text>
      <View style={styles.inputContainer}>
        <TouchableOpacity onPress={() => setModalVisible(true)}>
          <View style={styles.pickerContainer}>
            <Text style={styles.pickerText}>직장을 선택해주세요</Text>
          </View>
        </TouchableOpacity>
        <Modal
          animationType="slide"
      ...
      <Text style={styles.subtitle}>직업</Text>
      <View style={styles.inputContainer}>
        <TouchableOpacity onPress={() => setModalVisible(true)}>
          <View style={styles.pickerContainer}>
            <Text style={styles.pickerText}>직업을 선택해주세요</Text>
          </View>
        </TouchableOpacity>
        <Modal
          animationType="slide"
      ...
      <TouchableOpacity onPress={() => navigation.navigate('BasicInfo2')}>
        <View
          style={[
